...
public class FillForm_4 {
	...
	void fillForm() throws IOException {
		...
		try {
			File file = new File("./src/nandini/config/confData.properties");
			...
			driver.findElement(By.xpath("//input[@name='language' and @value='"+prop.getProperty("LanguageToLearn")+"']")).click();
			
			System.out.println("Step: Select Dream Company");
			driver.findElement(By.xpath("//input[@name='company' and @value='"+prop.getProperty("DreamCompany")+"']")).click();
	...
	public static void main(String args[]) throws IOException {
		FillForm_4 fillform4 = new FillForm_4();
		fillform4.fillForm();
