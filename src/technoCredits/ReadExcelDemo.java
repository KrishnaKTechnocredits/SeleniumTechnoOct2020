...
public class ReadExcelDemo {
	...
	static String[][] getExcelData(String fileName, String sheetName) throws IOException {
		String filePath = "./resources/testdata/" + fileName;
		File file = new File(filePath);
		FileInputStream inputStream = new FileInputStream(file);
		Workbook wb = new XSSFWorkbook(inputStream);
		/*
		 * if(fileName.contains(".xlsx")) // 2007 & + wb = new
		 * XSSFWorkbook(inputStream); else wb = new HSSFWorkbook(inputStream); /// .xls
		 * 1997 - 2003
		 */
