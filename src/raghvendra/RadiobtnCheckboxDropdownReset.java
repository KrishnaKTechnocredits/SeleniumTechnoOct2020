...
public class RadiobtnCheckboxDropdownReset {
	WebElement element;
	...
	void revertGenderSelection() {
		...
		if(maleSelected) {
			System.out.println("Male is selected by deafult so selecting Female now");
			driver.findElement(By.xpath("//input[@id='femaleG']")).click();
		}
		else {
			System.out.println("Female is selected by deafult so selecting Male now");
	...
	void validateReset() {
		driver.findElement(By.xpath("//input[@id='first name']")).sendKeys("Raghv");
	...
	public static void main(String[] args) {
		RadiobtnCheckboxDropdownReset radiobtnCheckboxDropdownReset=new RadiobtnCheckboxDropdownReset();
		radiobtnCheckboxDropdownReset.revertGenderSelection();
		radiobtnCheckboxDropdownReset.revertSelectionOfLanguage();
		radiobtnCheckboxDropdownReset.selectSecondLastDropdwon();
		radiobtnCheckboxDropdownReset.displayExprience();
		radiobtnCheckboxDropdownReset.validateReset();
	}
}
